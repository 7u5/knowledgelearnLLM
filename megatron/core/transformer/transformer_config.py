...
class TransformerConfig(ModelParallelConfig):
    ...
    next_latent_prediction_steps: Optional[int] = None
    """Number of steps for Next Latent Prediction."""

    lambda_next_h: float = 0.0

    lambda_kl: float = 0.0

    nextlp_loss_scaling_factor: Optional[float] = None
    """Weighting factor of Next Latent Prediction loss."""
            ...
            if self.rotary_interleaved:
                if not is_te_min_version("2.2.0.dev0"):
                    raise ValueError(
                        ...
                        "TE < 2.2.0.dev0. Please install TE >= 2.2.0.dev0"
                    )
