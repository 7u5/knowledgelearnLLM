...
def _add_network_size_args(parser):
    ...
    group.add_argument('--next-latent-prediction-steps', type=int, default=None,
                       help='Number of steps in next latent prediction paradigm.')
    group.add_argument('--lambda-next-h', type=float, default=None,
                       help='Lambda parameter for next latent prediction loss.')
    group.add_argument('--lambda-kl', type=float, default=None,
                       help='Lambda parameter for KL regularization in next latent prediction.')
    group.add_argument('--nextlp-loss-scaling-factor', type=float, default=1.0,
                       help='Scaling factor for next latent prediction loss.')
    return parser
