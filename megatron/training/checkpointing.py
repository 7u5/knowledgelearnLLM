...
def load_checkpoint(ddp_model, optimizer, opt_param_scheduler, load_arg='load', strict=True,
                    checkpointing_context=None, skip_load_to_model_and_opt=False, allow_ckpt=False):
    ...
    # rerun state
    try:
        if 'rerun_state_machine' in state_dict and not release and not args.finetune and state_dict['rerun_state_machine']:
