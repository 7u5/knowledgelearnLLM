...
def training_log(loss_dict, total_loss_dict, learning_rate, decoupled_learning_rate, iteration,
    ...
    if args.next_latent_prediction_steps is not None:
        from mindspeed_llm.core.transformer.next_latent_prediction import NextLatentPredLossLoggingHelper
        nlp_loss_scale = 1 / get_num_microbatches()
        NextLatentPredLossLoggingHelper.track_nextlat_metrics(
            nlp_loss_scale, iteration, writer, wandb_writer, total_loss_dict
        )
